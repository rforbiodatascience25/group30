...
The aim for this exercise is to practise our GitHub collaboration. We have done so by using the Gravier dataset and performing a little PC-analysis. The analysis i heavily inspired by Claus O. Wilke's report on a similar data-set.
...
Only a small subset from the pca_fit tibble is used to construct a readable plot.
